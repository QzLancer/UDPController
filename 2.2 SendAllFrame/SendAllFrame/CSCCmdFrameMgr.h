...
private:
	...
	bool m_PowerState[5] = { false };

	/// @brief 过压异常，Bit0-Bit5分别为1-6路交流，Bit6-Bit9为1-4路直流，Bit10-Bit15为备用
	bool m_OverVoltage[10] = { false };

	/// @brief 欠压异常，Bit0-Bit5分别为1-6路交流，Bit6-Bit9为1-4路直流，Bit10-Bit15为备用
	bool m_UnderVoltage[10] = { false };

	/// @brief 过流异常，Bit0-Bit5分别为1-6路交流，Bit6-Bit9为1-4路直流
	bool m_OverCurrent[10] = { false };

	/// @brief 过温异常，Bit0-Bit5分别为1-6路交流，Bit6-Bit9为1-4路直流，Bit10-Bit15为备用
